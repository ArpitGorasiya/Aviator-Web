                ...
                <FormControl>
                  {textarea ? (
                    <Textarea
                      ...
                      className={cn(
                        "placeholder:text-secondary bg-[#F6F6F7]! border border-border hover:border-main placeholder:font-normal min-h-[100px] focus-visible:ring-offset-0 focus-visible:ring-1 focus-visible:border-main text-primary text-base md:text-lg placeholder:text-base sm:placeholder:text-lg h-[52px] sm:h-[58px] px-6 rounded-[12px] pt-3 font-normal transition-colors",
                        fieldError?.message
